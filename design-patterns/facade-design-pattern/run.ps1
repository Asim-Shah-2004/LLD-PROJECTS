...
Write-Host "|   Facade Pattern - Home Theater Demo     |" -ForegroundColor Cyan
Write-Host "+------------------------------------------+" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    Write-Host ""
    Write-Host "[STEP] Running client.HomeTheaterClient..." -ForegroundColor Yellow
    Write-Host "---------------------------------------------"
    Write-Host ""

    & java "-Dfile.encoding=UTF-8" "-Dstdout.encoding=UTF-8" "-Dstderr.encoding=UTF-8" -cp $OutDir client.HomeTheaterClient
